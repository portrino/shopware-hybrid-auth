...
class Hybrid_Provider_Model_OAuth1 extends Hybrid_Provider_Model {
	...
	function loginFinish() {
		if ($_SERVER['REQUEST_METHOD'] === 'GET') {
			$oauth_token = filter_input(INPUT_GET, 'oauth_token') ? filter_input(INPUT_GET, 'oauth_token') : "";
			$oauth_verifier = filter_input(INPUT_GET, 'oauth_verifier') ? filter_input(INPUT_GET, 'oauth_verifier') : "";
		} else {
			if ($_SERVER['REQUEST_METHOD'] === 'POST') {
				$oauth_token = filter_input(INPUT_POST, 'oauth_token') ? filter_input(INPUT_POST, 'oauth_token') : "";
				$oauth_verifier = filter_input(INPUT_POST, 'oauth_verifier') ? filter_input(INPUT_POST, 'oauth_verifier') : "";
			}
		}
